...
def main() -> None:
    ...
    DATASET_PATH1 = './X_train2.npy'
    DATASET_PATH2 = './y_train2.npy'
    DEFAULT_SERVER_ADDRESS = "[::]:8080"
    # VALID_DATA_PATH = './server.npy'
    VALID_DATA_PATH1 = './X_test2.npy'
    VALID_DATA_PATH2 = './y_test2.npy'
    X_test2=load_datasetx(VALID_DATA_PATH1)
    y_test2=load_datasetx(VALID_DATA_PATH2) 
    # Load model and data
    model = modelFunctions.load_model((40,30,1),X_test2,y_test2)
