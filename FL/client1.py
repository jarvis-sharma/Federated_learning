...
def main() -> None:
    ...
    DATASET_PATH1 = './X_train1.npy'
    DATASET_PATH2 = './y_train1.npy'
    DEFAULT_SERVER_ADDRESS = "[::]:8080"
    # VALID_DATA_PATH = './server.npy'
    VALID_DATA_PATH1 = './X_test1.npy'
    VALID_DATA_PATH2 = './y_test1.npy'
    X_test1=load_datasetx(VALID_DATA_PATH1)
    y_test1=load_datasetx(VALID_DATA_PATH2) 
    l=[]
    # Load model and data
    model = modelFunctions.load_model((40,30,1),X_test1,y_test1)
...
l=np.array(l)
np.save('./first',l,allow_pickle=True)    